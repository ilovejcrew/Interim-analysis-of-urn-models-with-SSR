...
for  ( i in 1:m ){
        ...
        stat=abs((mean(xx1)-mean(xx2))/sqrt(var(xx1)/N1+var(xx2)/N2))
        ...
        stat2=abs((mean(xx1)-mean(xx2))/sqrt(var(xx1)/N1+var(xx2)/N2))
        ...
        number=number+1
         reject2=reject2+1
          ...
          cpfl = FALSE
          mu_1 = (mean(xx2)-mean(xx1))/sqrt(var(xx1)/(N1/(N1+N2))+var(xx2)/(N2/(N1+N2)))
